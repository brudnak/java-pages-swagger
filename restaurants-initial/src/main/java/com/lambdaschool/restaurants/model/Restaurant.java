...
public class Restaurant extends Auditable
{
    ...
    @Size(min = 2, max = 2, message = "State is the two character abbreviation")
    private String state;

    @Email(message = "Email should be valid username@domain.toplevel - jrmmba@outlook.com")
    private String ourEmail;

    @ApiModelProperty(name = "telephone", value = "Restaurant Telephone", example ="555-555-5555")
